...
export const mockSportsCatalog: SportDto[] = [
  {
    ...
    name: 'Fútbol',
    displayOrder: 1,
    modalities: [{ id: 'modality-football-5', code: 'football-5', name: 'Fútbol 5', playersCount: 10, durationMinutes: 60, displayOrder: 1 }],
  },
  {
    id: 'sport-padel',
    code: 'padel',
    name: 'Pádel',
    displayOrder: 2,
    modalities: [{ id: 'modality-padel-doubles', code: 'padel-doubles', name: 'Dobles', playersCount: 4, durationMinutes: 90, displayOrder: 1 }],
  },
];
